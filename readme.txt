...
(1) Just enter your IP of device.
Note: you can check your ip using ifconfig command in terminal.
...
(5) type the commands given to you on opened terminal. After exploit just tap or launch the installed PAYLOAD for single time and you will be connected.
...
use help command to list the things you can do.


                                                                Copyright@HacksByLogOut
